...
// --- 新增：LUT 优化控制 ---
uniform sampler2D m_lutSampler; // 对应 1024x32 纹理
...
// 快速路径：适配 32x32x32 LUT (平铺为 1024x32 2D 纹理)
vec3 samplePQLUT(vec3 color)
{
    ...
    // 计算 X 轴偏移：每个 slice 占 32 像素，总宽 1024
